...
import io.cucumber.core.internal.com.fasterxml.jackson.databind.ser.std.ObjectArraySerializer;
import io.cucumber.java.en.And;
import io.cucumber.java.en.Given;

import static POM.CPPOM.*;
import static POM.ConditionOptionEnum.CLICKABLE;
import static POM.ConditionOptionEnum.VISIBLE;
import static POM.MWLPOM.*;
import static POM.MWLPOM.WISHLIST_SHOWS_UP;

public class CPSTP extends BaseMethods {
